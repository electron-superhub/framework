...
import tpl_win_nsisInstaller_checkDir from "#virtual/templates/installer/win/nsis-installer-checkDir";
...
export function renderWinNsisInstaller(
  data: Record<string, any>,
  checkDir: boolean = false
) {
  if (checkDir) return renderTemplate(tpl_win_nsisInstaller_checkDir, data);
